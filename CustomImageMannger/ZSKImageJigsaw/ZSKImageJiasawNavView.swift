...
class ZSKImageJiasawNavView: UIView {
    ...
    lazy var closeBtn: UIButton = {
        ...
        btn.setImage(ZSKimageJigsawManager.getZSKImage(from: "message_icon_delete")?.withRenderingMode(.alwaysTemplate), for: .normal)
        btn.tintColor = .zsk_tertiaryTitleColr
