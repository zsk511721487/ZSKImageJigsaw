...
class ZSKImageEditView: UIView {
    ...
    fileprivate lazy var cancleButton: UIButton = {
        ...
        btn.setImage(ZSKimageJigsawManager.getZSKImage(from: "zsk_cancle_icon"), for: .normal)
    ...
    fileprivate lazy var changeButton: UIButton = {
        ...
        btn.bounds = CGRect(x: 0, y: 0, width: 50, height: 50)
        btn.setImage(ZSKimageJigsawManager.getZSKImage(from: "zsk_change_image_icon"), for: .normal)
        btn.tag = 10001
        btn.addTarget(self, action: #selector(opretionAction(sender:)), for: .touchUpInside)
        btn.showsTouchWhenHighlighted = false
        return btn
    ...
    override init(frame: CGRect) {
        ...
        cancleLabel.textColor = UIColor.init(red: 102/255.0, green: 102/255.0, blue: 102/255.0, alpha: 1)
        ...
        changeLabel.textColor = UIColor.init(red: 102/255.0, green: 102/255.0, blue: 102/255.0, alpha: 1)
