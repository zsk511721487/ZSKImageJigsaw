...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "张少康"
  # spec.authors            = { "张少康" => "511721487@qq.com" }
  # spec.social_media_url   = "https://twitter.com/张少康"
  ...
  #spec.source_files  = "Classes", "ZSKImageJiasaw/**/*.{h,m}"
  ...
  # spec.ios.vendored_frameworks = 'ZSKImageJiasaw.framework'
